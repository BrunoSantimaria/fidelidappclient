...
import { Navigation } from "@/dashboard/components/sidebar/Navigation";
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={6}>
                <TextField
                  fullWidth
                  type='number'
                  label='Personas por slot'
                  value={peoplePerSlot}
                  onChange={(e) => setPeoplePerSlot(Number(e.target.value))}
                  required
                />
              </Grid>
