...
export const PromotionMetrics = ({ metrics }) => {
  ...
  return (
    <section className='flex flex-col md:flex-row lg:flex-row justify-between xs:flex-col w-[95%] gap-6'>
      <div className='w-full md:max-w-[20%] lg:max-w-[20%] relative flex flex-col shadow-md shadow-neutral-200 bg-gradient-to-br from-gray-50 to-main/40 space-y-4 p-6 rounded-md m-0 text-left'>
