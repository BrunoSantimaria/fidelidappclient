...
export const sections: Section[] = [
  {
    ...
    content: `Comenzamos con un análisis profundo de tu negocio y tus clientes para entender tus necesidades y desafíos específicos.
  Identificamos los principales retos que enfrentan los negocios, como la falta de fidelización de clientes y la baja recurrencia de citas o reservas.
  ...
  },
  {
    ...
    content: `Configuramos tu cuenta y promociones en Fidelidapp, asegurando una integración sin problemas con tu operación actual.
  Nos encargamos de la integración técnica y operativa, eliminando fricciones en la adopción de nuevas herramientas.
  ...
  },
  {
    id: 3,
    title: "Capacitación",
    content: `Capacitamos a tu equipo para maximizar el uso de Fidelidapp y lanzamos la primera promoción piloto.
  Aseguramos que todo el equipo esté alineado y capacitado para sacar el máximo provecho de Fidelidapp.
  ...
  },
  {
    id: 4,
    title: "Lanzamiento",
    content: `Seguimos de cerca el desempeño de las promociones y ajustamos la estrategia según los datos recolectados.
  Evaluamos continuamente los resultados para detectar áreas de mejora.
  ...
  {
    id: 5,
    title: "Éxito Continuo",
    content: `Con nuestro soporte continuo y mejoras constantes, tu negocio disfruta de un crecimiento sostenido en la lealtad y satisfacción del cliente.
  Nos aseguramos de que tu programa de fidelización se mantenga actualizado y efectivo a lo largo del tiempo.
