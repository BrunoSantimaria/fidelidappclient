      ...
      <Box sx={{ marginTop: { xs: 30, md: 0 }, paddingX: { xs: 2, md: 6 }, textAlign: { xs: "left", sm: "left", md: "left", lg: "left" } }}>
        ...
        >
          <span className='w-full leading-6'>
            Con Fidelidapp crea y gestiona <span className='font-bold'>programas de lealtad</span> con puntos, promociones, tarjetas virtuales y campañas de{" "}
            <span className='font-bold'>email marketing</span> masivo. Aumenta la lealtad de tus clientes. <br></br>
